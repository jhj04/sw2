...
#define _DUTY_MAX 2260 // 2000
#define _DUTY_NEU 1665 // 1500
#define _DUTY_MIN 1097 // 1000

#define _SERVO_ANGLE_DIFF  50  // Replace with |D - E| degree
#define _SERVO_SPEED       50  // servo speed

#define _BANGBANG_RANGE   3000   // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return (558 + (-1.82)*a_value + 1.49E-03 * a_value * a_value);
}
